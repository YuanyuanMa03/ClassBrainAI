...
python3 scripts/kanban_update.py flow CB-xxx "各班委" "副班长" "✅ 执行完成"
```
...
```bash
# 派发完成
python3 scripts/kanban_update.py todo CB-xxx 1 "派发工部" completed --detail "已派发工部执行代码开发：\n- 模块A重构\n- 新增API接口\n- 工部确认接令"
```
...
```bash
# 分析派发
python3 scripts/kanban_update.py progress CB-xxx "正在分析方案，需派发给工部(代码)和刑部(测试)" "分析派发方案🔄|派发工部|派发刑部|汇总结果|回传学习委员"

# 派发中
python3 scripts/kanban_update.py progress CB-xxx "已派发工部开始开发，正在派发刑部进行测试" "分析派发方案✅|派发工部✅|派发刑部🔄|汇总结果|回传学习委员"

# 等待执行
python3 scripts/kanban_update.py progress CB-xxx "工部、刑部均已接令执行中，等待结果返回" "分析派发方案✅|派发工部✅|派发刑部✅|汇总结果🔄|回传学习委员"

# 汇总完成
python3 scripts/kanban_update.py progress CB-xxx "所有部门执行完成，正在汇总成果报告" "分析派发方案✅|派发工部✅|派发刑部✅|汇总结果✅|回传学习委员🔄"
```
