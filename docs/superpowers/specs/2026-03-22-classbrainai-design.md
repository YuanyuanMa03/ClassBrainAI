...
> 将 edict 三省六部制多 Agent 系统改造为班级主题
>
> 设计日期：2026-03-22
...
| 中书省 | 学习委员 | study | 方案规划、分解任务 |
| 门下省 | 班委主席 | chair | 方案审议、质量把关 |
| 尚书省 | 副班长 | vice_monitor | 任务派发、协调执行 |
| 兵部 | 技术委员 | technical | 代码、技术任务 |
| 工部 | 后勤委员 | logistics | 基础设施、脚本工具 |
| 户部 | 财务委员 | finance | 数据统计、资源管理 |
| 礼部 | 文艺委员 | arts | 文档、知识库 |
| 刑部 | 纪律委员 | discipline | 规范、质量检查 |
